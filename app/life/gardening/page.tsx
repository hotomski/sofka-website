      ...
      <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-8 max-w-5xl w-full">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <div className="p-4 bg-white bg-opacity-90 rounded-lg shadow-lg border border-gray-200">
            <img src="/images/gardening/photo5.jpg" alt="Gardening Photo 5" className="w-full h-[32rem] object-cover rounded-lg" />
          </div>
          {/* Photo 2 */}
          <div className="p-4 bg-white bg-opacity-90 rounded-lg shadow-lg border border-gray-200">
            <img src="/images/gardening/photo6.jpg" alt="Gardening Photo 6" className="w-full h-[32rem] object-cover rounded-lg" />
          </div>
          {/* Photo 3 */}
          <div className="p-4 bg-white bg-opacity-90 rounded-lg shadow-lg border border-gray-200">
